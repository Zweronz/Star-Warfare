...
public class CMIVersusBattleHUD : VersusBattleHUD
{
	...
	public CMIVersusBattleHUD(UIStateManager stateMgr)
	{
	...
	{
		CreateForTMDGift();
		GameUIManager.GetInstance().LoadHUD(HUDBattle.HUDType.CMI, stateMgr, this);
