...
public class NetStatisticsUIForTDM : NetStatisticsUIBase
{
	...
	public NetStatisticsUIForTDM(UIStateManager stateMgr)
		: base(stateMgr)
	{
	}
	...
	public void InitBluePlayers()
	{
		...
		for (int i = 0; i < 4; i++)
		{
			...
			if (i < list.Count)
			{
				...
				uIPlayerScoreIcon.m_deathNum.SetNumeric(unitUI, 3, UIConstant.FormatNum(list[i].VSStatistics.Death));
				...
				uIPlayerScoreIcon.m_assistsNum.SetNumeric(unitUI, 4, UIConstant.FormatNum(list[i].VSStatistics.Assist));
