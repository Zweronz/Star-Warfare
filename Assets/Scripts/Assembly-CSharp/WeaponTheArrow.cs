...
public class WeaponTheArrow : Weapon
{
	...
	public override void Loop(float deltaTime)
	{
		...
		GameObject original = Resources.Load("Effect/update_effect/effect_thearrow_attack") as GameObject;
		...
		component.GunType = WeaponType.TheArrow;
		...
		{
			PlayerFireRocketRequest request = new PlayerFireRocketRequest(42, gunfire.position, normalized2, trackingID);
