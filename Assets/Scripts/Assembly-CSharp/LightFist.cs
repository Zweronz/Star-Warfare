...
public class LightFist : Weapon
{
	...
	{
		gun.transform.GetChild(0).GetChild(0).renderer.enabled = true;
		gun.transform.GetChild(0).GetChild(1).renderer.enabled = true;
	...
	public override void GunOff()
	{
		if (gun != null)
		{
			gun.transform.GetChild(0).GetChild(0).renderer.enabled = false;
			gun.transform.GetChild(0).GetChild(1).renderer.enabled = false;
