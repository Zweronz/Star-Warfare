...
public class NetStatisticsUIForCTFFFA : NetStatisticsUIBase
{
	...
	public NetStatisticsUIForCTFFFA(UIStateManager stateMgr)
		: base(stateMgr)
	{
	}
	...
	public override void Create()
	{
		...
		for (int j = 0; j < num; j++)
		{
			...
			uIPlayerScoreIcon.m_secureFlagsNum.SetNumeric(unitUI, 4, UIConstant.FormatNum(players[j].VSStatistics.SecureFlags));
			uIPlayerScoreIcon.m_secureFlagsNum.Rect = new Rect(secureFlagsTitleImg.Rect.x, modulePositionRect.y - num3, secureFlagsTitleImg.Rect.width, modulePositionRect.height);
			uIPlayerScoreIcon.m_assistFlagsNum.AlignStyle = UINumeric.enAlignStyle.center;
			uIPlayerScoreIcon.m_assistFlagsNum.SetNumeric(unitUI, 3, UIConstant.FormatNum(players[j].VSStatistics.AssistFlags));
			uIPlayerScoreIcon.m_assistFlagsNum.Rect = new Rect(assistFlagsTitleImg.Rect.x, modulePositionRect.y - num3, assistFlagsTitleImg.Rect.width, modulePositionRect.height);
