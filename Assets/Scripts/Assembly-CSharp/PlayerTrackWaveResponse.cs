...
internal class PlayerTrackWaveResponse : Response
{
	public byte type;
	...
	public override void ProcessLogic()
	{
		...
		if (gameWorld != null)
		{
			string path = "ZB_effect/black_hole_beam";
			...
			TrackWaveScript component = gameObject.GetComponent<TrackWaveScript>();
			component.dir = dir;
