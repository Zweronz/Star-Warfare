...
public class ArmorVerify
{
	...
	public ArmorVerify(BodyType type, int id)
	{
		armorID = (byte)id;
		armorType = type;
		int num = 0;
		LoadConfig((armorType != BodyType.Bag) ? ((int)(armorID * 4 + armorType)) : (Global.TOTAL_ARMOR_NUM * 4 + armorID));
	}
	...
	public void LoadConfig(int resID)
	{
