...
public class PlayerImpactWaveRequest : Request
{
	protected byte type;
	...
	public PlayerImpactWaveRequest(byte type, Vector3 pos, Vector3 dir)
	{
		this.type = type;
		x = (short)(pos.x * 10f);
		y = (short)(pos.y * 10f);
	...
	public PlayerImpactWaveRequest(byte type, Vector3 pos, Vector3 dir, int trackingID)
	{
		this.type = type;
		x = (short)(pos.x * 10f);
		y = (short)(pos.y * 10f);
