...
public class Record291 : IRecordset
{
	private UserState user;

	public static string version = "291";

	public static string Eversion = "292";

	public static string EEversion = "293";

	public static string EEEversion = "294";

	public static string EEEEversion = "296";

	public Record291(UserState user)
	{
		this.user = user;
	}
	...
	public void SaveData(BinaryWriter bw)
	{
		...
		bw.Write(user.GetPurchaseSergeant());
		...
		Debug.Log("user.m_promotion.id: " + user.m_promotion.id);
		bw.Write(user.m_promotion.id);
	...
	public void LoadData(BinaryReader br)
	{
		...
		bool purchaseSergeant = br.ReadBoolean();
		...
		user.m_promotion.id = br.ReadInt32();
		...
		user.SetPurchaseSergeant(purchaseSergeant);
