public class UploadArmorAndBagRequest : Request
{
	protected UserState userState;

	public UploadArmorAndBagRequest(UserState userState)
	{
	...
	public override byte[] GetBytes()
	{
		...
		byte b = (byte)(Global.BAG_MAX_NUM + Global.AVATAR_PART_NUM + 47 + Global.TOTAL_ARMOR_HEAD_NUM + Global.TOTAL_ARMOR_BODY_NUM + Global.TOTAL_ARMOR_ARM_NUM + Global.TOTAL_ARMOR_FOOT_NUM + Global.TOTAL_ARMOR_BAG_NUM + Global.TOTAL_ITEM_NUM + 1 + 4 + 4 + 4 + 4 + 2 + 8 + 2 + 2 + 1 + 1 + Global.TOTAL_SOLO_BOSS_NUM + Global.TOTAL_COOP_BOSS_NUM + Global.TOTAL_COOP_BOSS_NUM + text.Length + 1 + 1);
